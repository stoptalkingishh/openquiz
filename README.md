...
modification, and redistribution when its conditions are met. Copyright holders
may offer separate terms for users who need an alternative to the AGPL; those
terms do not restrict the AGPL grant.

Third-party software and study-content attributions are recorded in
